                  ...
                  <form class="user" action="/register" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" name="username"
                        class="form-control form-control-user @error('username') is-invalid
                        @enderror"
                        id="username" placeholder="Username" required value="{{ old('username') }}">
                      @error('username')
                        <div class=" invalid-feedback">
                          Username yang kamu pilih gak valid
                        </div>
                      @enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-center">
                      ...
                      <a class="small text-decoration-none" href="{{ url('/login') }}">Login</a>
                    </div>
                    <div class="text-center">
                      <small>Kembali Ke </small>
                      <a class="small text-decoration-none" href="{{ url('/') }}>Home</a>
                    </div>
                </div>
              </div>
            </div>
